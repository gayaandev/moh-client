...
import DepartmentPlanningPolicyPage from './components/public/pages/Departments/DepartmentPlanningPolicyPage'; // Import DepartmentPlanningPolicyPage
      ...
      <AuthProvider> {/* Wrap the entire application with AuthProvider */}
        <Router>
          <Routes>
            ...
            <Route path="/planing-policy-and-coordination-department" element={<PublicLayout><DepartmentPlanningPolicyPage /></PublicLayout>} />
