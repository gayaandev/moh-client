  ...
  return (
    <div className="container mx-auto px-6 py-12 w-full lg:w-4/5">
      {column1 && column1.images && column1.images.length > 0 && (
        <div className="mb-12">
          <img src={column1.images[0]} alt="KMTI Main Image" className="w-full h-[500px] object-cover rounded-lg shadow-lg" />
        </div>
      )}

      {column2 && (
        <div className="bg-white p-8 rounded-lg shadow-lg flex flex-col md:flex-row-reverse items-center mb-12">
